  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">How bad is your team?</h2>
        <p class="mt-3 text-gray-600">
          Enter your User name and press Enter this Tool will calculate how your
          team has been performing in comparison to the enemy Team.
        </p>
        <div class="mt-5">
          <label
            for="summoner_name"
      ...
      <div class="flex justify-center pt-4 space-x-2">
        <a
          href="https://github.com/giuseppeCruised/AmITheProblem/tree/master"
          target="_blank"
          ><svg
